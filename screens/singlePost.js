            ...
            <View>
                <PostCard>
                    <View style={styles.cardHeader}>
                        ...
                        <Text style={styles.username}>barb</Text>
                        <Image source={{
                    ...
                    <View>
                        <Image source={images.photos[1]} style={styles.photo} />
                    </View>
                </PostCard>
                <View style={{ flexDirection: "row", marginTop: 10, }}>
                    <View style={{ flexDirection: "row", justifyContent: 'flex-start', width: "50%" }}>
                        <View style={{ flexDirection: "row", left: 10, justifyContent: "flex-start" }}>
                            {like ? <FontAwesome name="heart" size={27} color="red" onPress={() => setLike(!like)} /> :
                                <FontAwesome name="heart-o" size={27} color="black" onPress={() => setLike(!like)} />
                            }
                            <Ionicons name="ios-chatbubbles-outline" size={27} style={{ paddingLeft: 15 }} color="black" onPress={() => navigation.navigate('Comments')} />
                            <Feather style={{ paddingLeft: 15 }} name="send" size={27} color="black" />
                        </View>
                    </View>
                    <View style={{ width: "50%", paddingRight: 13 }}>
                        {save ?
                            <FontAwesome style={{ textAlign: 'right' }} name="bookmark" size={26} color="black" onPress={() => setSave(!save)} />
                            :
                            <FontAwesome style={{ textAlign: 'right' }} name="bookmark-o" size={26} color="black" onPress={() => setSave(!save)} />}
