...
import { FlatList, Image, View, Dimensions, StyleSheet, Text, TouchableOpacity, SafeAreaView, StatusBar } from 'react-native';
import { ScrollView } from 'react-native-gesture-handler';
import { NativeBaseConfigProvider } from 'native-base';
import { LinearGradient } from 'expo-linear-gradient';
import { challenges, logos, darkMode } from '../styles/global';
...
export default function Trends() {
    ...
    const renderHeader = () => (
        <View style={{ flexDirection: 'row', position: "relative", backgroundColor: "black" }}>
            ...
            <ScrollView horizontal={true} style={{ paddingVertical: 15, paddingHorizontal: 10, backgroundColor: '#141414' }}>
                ...
                <TouchableOpacity
                    ...
                    <AntDesign name="pluscircleo" style={{ fontSize: 40, color:'rgba(255,255,255, 1)' }} />
                </TouchableOpacity>
            </ScrollView>
        </View>
    );
